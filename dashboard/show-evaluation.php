                    ...
                    <div class="col-xl-12 col-lg-12">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 ">
                                <h5 class="m-0 font-weight-bold text-info text-center">تقييمات النظام الالي</h5>
                            </div>
                            </a>
                            <!-- Card Body -->
                                        ...
                                        if($stmt->rowCount() > 0) :
                                            ...
                                            foreach ($rows as $row) :
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <?=$row['depart']?> </td>
                                                        <td><a href="report.php?id=<?=$row['employee_id']?>" class="btn btn-primary">  عرض التقرير  <i class="fas fa-clipboard-list"></i></a> </td>
                                                </tr>
                                            <?php
                                            endforeach;
                                        endif;
...
<!--                                <div class="card-header py-3 ">-->
<!--                                    <h5 class="m-0 font-weight-bold text-info text-center">تقييمات النظام المخصص</h5>-->
<!--                                </div>-->
<!--                            </a>-->
<!--                            < Card Body -->
...
<!--                                                        <td><a href="#" class="text-info"> --><?//=$row['name']?><!--</a></td>-->
<!--                                                        <td> --><?//=$row['depart']?><!-- </td>-->
<!--                                                        <td><a href="report-coustome.php?id=--><?//=$row['emp_id']?><!--" class="btn btn-primary">  عرض التقرير  <i class="fas fa-clipboard-list"></i></a> </td>-->
<!--                                                    </tr>-->
<!--                                                --><?php
//                                                endforeach;
//                                            endif;
