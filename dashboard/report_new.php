...
$stmtx=$conn->prepare("SELECT * FROM `evolution_coustme` JOIN elements_evaluation ON elements_evaluation.id = evolution_coustme.evaluate_id WHERE evolution_coustme.emp_id = :id");
$stmtx->bindValue(":id", $emp_id);
$stmtx->execute();
                    ...
                    <div class="col-xl-12 col-md-12 mb-4" dir="rtl">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 bg-info">
                                <h6 class="m-0 font-weight-bold text-white Font-tajawal text-center">  تقرير تقييم الموظف <span><?=$row['name']?></span> </h6>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="text-right">
                                    ...
                                    <fieldset  class="border p-3 form-group">
                                        ...
                                        <h3 class="text-primary text-center p">الاهداف</h3>
                                        <hr class="pb-3">
                                    <div class="form-group row " >
                                        <label for="username" class="col-sm-2 col-form-label text-dark font-weight-bold"> تقديم دورات في نفس المجال</label>
                                        <div class="col-sm-2">
                                        ...
                                        <div class="form-group row " >
                                        <label for="username" class="col-sm-2 col-form-label text-dark font-weight-bold"> أنجاز جميع الخطابات المطلوبة</label>
                                        <div class="col-sm-2">
                                        ...
                                        <div class="form-group row " >
                                        <label for="username" class="col-sm-2 col-form-label text-dark font-weight-bold"> تحسين الأداء الأكاديمي للطلاب</label>
                                        <div class="col-sm-2">
                                        ...
                                        <div class="form-group row " >
                                        <label for="username" class="col-sm-2 col-form-label text-dark font-weight-bold"> عنصر تقيم 4</label>
                                        <div class="col-sm-2">
                                        ...
                                        <label for="username" class="col-sm-2 col-form-label text-primary font-weight-bold"> النتيجة </label>
                                        <div class="col-sm-2">
                                        ...
                                        <h3 class="text-primary text-center p-1">الجدارة</h3>
                                        <hr class="pb-3">
                                        <div class="form-group row " >
                                            <label for="username" class="col-sm-2 col-form-label text-dark font-weight-bold"> حس المسؤلية</label>
                                            <div class="col-sm-2">
                                        ...
                                        <div class="form-group row " >
                                            <label for="username" class="col-sm-2 col-form-label text-dark font-weight-bold"> التعاون </label>
                                            <div class="col-sm-2">
                                        ...
                                        <div class="form-group row " >
                                            <label for="username" class="col-sm-2 col-form-label text-dark font-weight-bold"> تحقيق النتائج </label>
                                            <div class="col-sm-2">
                                        ...
                                        <div class="form-group row " >
                                            <label for="username" class="col-sm-2 col-form-label text-dark font-weight-bold">  الارتباط الوظيفي  </label>
                                            <div class="col-sm-2">
                                        ...
                                        <?php  ?>
                                        <h3 class="text-primary text-center p-1">تقييم المخصص</h3>
                                        <?php if(empty($rowsx)):?>
                                        <div class="text-muted text-center">
                                            <i class="fas fa-exclamation-triangle text-danger"></i>
                                            لم يتم التقييم بعد
                                            <span class=""><a href="evaluate-emp_coustom.php?id=<?php echo $emp_id;?>" class="btn-link"> تقيم الان </a> </span>
                                        </div>
                                        <?php endif;?>
                                        ...
                                        <div class="form-group pt-4 row " >
                                            <label for="username" class="col-sm-2 col-form-label text-primary font-weight-bold"> النتيجة </label>
                                            <div class="col-sm-2">
                                                <input type="text" name="name" class="form-control form-control-user  text-center text-primary   evlation "  value="%<?php echo $custom = ($sum/sizeof($rowsx)) * 20; ?>" style=" " disabled>
                                            </div>
                                        </div>
                                    </fieldset>
                                    <?php else: $custom = 0; endif; ?>
                                    ...
                                    <fieldset  class="border p-3 form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-4 text-center">
                                                ...
                                                <input type="text" name="job_title" class="form-control form-control-user text-center reslut" style="background-color: white;" value="%<?php  echo ($total + $custom) / 2 ?>" disabled>
                                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="font-size: 16px;">
                <div class="text-center">
                    ...
                    <a href="delete-page.php?id=<?=$emp_id?>&type=report" id="delete-link" class="btn btn-dark"> نعم </a>
                </div>
            </div>
        </div>
