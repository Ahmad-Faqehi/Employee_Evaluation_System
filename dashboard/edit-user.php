                    ...
                    <div class="col-xl-12 col-md-12 mb-4" dir="rtl">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-dark Font-tajawal text-center">  تعديل بيانات المشرف  </h6>
                            </div>
                            <div class="card-body">
                                ...
                                if(isset($_POST['update'])){
                                    ...
                                    $stmte=$conn->prepare("SELECT email FROM admin where email = :email");
                                    ...
                                    $stmte->execute();
                                        ...
                                        $stmtu=$conn->prepare("UPDATE `admin` SET `name`=:name,`email`=:email WHERE id = :id");
                                        ...
                                        if($stmtu->rowCount() > 0){
                                            $updated = true;
                                            echo "<div class=\"alert alert-success text-center\"> تم التحديث بيانات المشرف بنجاح </div>";
                                        }
                                    }
                                ?>
                                ...
                                <form action="" method="post" class="text-right">
                                    ...
                                    <label for="username" class="pull-right text-dark"> اسم المشرف </label>
                                    ...
                                    <label for="username" class="pull-right text-dark">إئميل المشرف</label>
                                    <div class="form-group">
