                    ...
                    <div class="col-xl-12 col-lg-12">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 ">
                                <h5 class="m-0 font-weight-bold text-dark text-center"> عناصر التقييم</h5>
                            </div>
                            ...
                            <div class="card-body" style="direction: ltr;">
                                ...
                                if (isset($_POST['submit'])){
                                    ...
                                    if(empty($name)){
                                        echo "<div class=\"alert alert-danger text-right\">  يجب كتابة اسم العنصر </div>";

                                    }elseif($stmt->rowCount() > 0){
                                        echo "<div class=\"alert alert-danger text-right\"> هذا العنصر موجود مسبقاً</div>";
                                    }else{
                                        ...
                                        if($stmt->rowCount() > 0) :
                                            ...
                                            foreach ($rows as $row) :
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="edit_element_evaluation.php?id=<?=$row['id']?>" class="btn btn-info">تعديل</a> &nbsp;<a href="#dlete" onclick="myf(<?=$row['id']?>)" class="btn btn-danger">حذف</a> </td>
                                                </tr>
                                            <?php
                                            endforeach;
                                        endif;
                                ...
                                <div class="text-center">
                                    <a href="#" data-toggle="modal" data-target="#add-user-form" class="btn btn-success btn-icon-split"><span class="icon text-white-50"><i class="fas fa-plus"></i></span><span class="text"> أضافة عنصر تقييم</span></a>
                                </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header bg-dark">
                ...
                <h4 class="modal-title text-white"> أضافة عنصر تقييم </h4>
            </div>
            <div class="modal-body" style="font-size: 16px;">
                <div class=" text-right p-3"  >
                    <form method="post" action="">
                        <div class="form-group">
                            <label class="text-dark">اسم عنصر التقييم</label>
