...
$stmt=$conn->prepare("SELECT * FROM evaluator WHERE id=:id");
                    ...
                    <div class="col-xl-12 col-md-12 mb-4" dir="rtl">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-dark Font-tajawal text-center">  تعديل بيانات المقيم  </h6>
                            </div>
                            <div class="card-body">
                                ...
                                if(isset($_POST['update'])){
                                    ...
                                    $stmte=$conn->prepare("SELECT email FROM evaluator where email = :email");
                                    ...
                                    $stmte->execute();
                                        ...
                                        $stmtu=$conn->prepare("UPDATE `evaluator` SET `name`=:name,`email`=:email, password = :pass WHERE id = :id");
                                        ...
                                        if($stmtu->rowCount() > 0){
                                            $updated = true;
                                            echo "<div class=\"alert alert-success text-center\"> تم التحديث بيانات المقيم بنجاح </div>";
                                        }
                                    }
                                ?>
                                ...
                                <form action="" method="post" class="text-right">
                                    ...
                                    <label for="username" class="pull-right text-dark"> اسم المقيم </label>
                                    ...
                                    <label for="username" class="pull-right text-dark">إئميل المقيم</label>
                                    <div class="form-group">
                                    ...
                                    <label for="username" class="pull-right text-dark">كلمة سرر جديدة <small>أختياري</small>  </label>
                                    <div class="form-group">
                                        <input type="password" name="password" value="<?php echo $row['password']?>" class="form-control form-control-user"  >
                                    </div>
